...
class Database:
    ...
    def _initialize_schema(self):
        ...
        # Sessions table (renamed from threads)
        cursor.execute("""
        ...
        # Index for sorting sessions by last activity (IMPORTANT!)
        cursor.execute("""
        ...
        # Index for active_processes
        cursor.execute("""
            CREATE INDEX IF NOT EXISTS idx_active_processes_run_id 
            ON active_processes(run_id)
        """)
        
        cursor.execute("""
            CREATE INDEX IF NOT EXISTS idx_active_processes_status 
            ON active_processes(status)
        """)
